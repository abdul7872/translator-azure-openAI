    ...
    <header className='flex items-center justify-between py-4 px-8 border-b mb-5'>
        <Link href={'/'}>
          <div className='flex items-center overflow-hidden cursor-pointer'>
            <Image src={'/logo/logo.svg'} alt='logo' className='object-contain overflow-hidden rounded-lg h-10 md:h-14' height={40} width={100} />
            <span className='md:text-2xl font-bold pl-4'>Translator APP</span>
          </div>
        </Link>
      { userId ? (
          <UserButton />
